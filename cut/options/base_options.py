...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--center_patch_offset', type=int, default=50, help='max random offset in pixels around the image center when using center_patch preprocess')
